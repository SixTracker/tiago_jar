...
if __name__ == "__main__":
    ...
    cursor.execute("SELECT idComponente, nome FROM Componente WHERE fkServidor = %s", (29,))
    ...
    for componente_id, componente_nome in componentes.items():
        if not any(componente_id == comp[0] for comp in componentes_servidor):
            ...
            cursor.execute("INSERT INTO Componente (nome, fkServidor) VALUES (%s, 29)", (componente_nome,))
